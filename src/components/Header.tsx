...
const Header: React.FC = () => {
  ...
  return (
    <header className="w-full h-[60px] border-b border-[#F8E6F8] bg-white shadow-md">
      <div className="container mx-auto flex items-center justify-between px-4 py-4 md:px-6 h-full bg-white">
        <div className="pl-4">
          <Link href="/">
            <Image
              src="/header-logo.svg"
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden absolute left-0 right-0 bg-white shadow-md border-t z-50">
